...
namespace Loto
{
    public static class Otsu
    {
        ...
        public static unsafe int ZnajdywanieRóźnicyŚrednich(int[] histogram,out int A,out int S,out int B)
        {
            ...
            return ZnajdywanieRóźnicyŚrednichZProgiem(S, histogram,out A,out B);
        ...
        public static unsafe void Progój(bool Odwrotność, int WielkośćObrazu, byte* Obraz)
        {
            int[] his = PobierzHistogram(new Size(1,WielkośćObrazu), Obraz);
            Progój(Odwrotność,WielkośćObrazu, MetodaOtsu(his), Obraz);
       ...
       public static int[] PobierzHistogram(int[] t,out int Min)
        {
             Min = t.Min();
            int Max = t.Max();
            int Wielkość = Max - Min + 1;
            int[] tb = new int[Wielkość];
        ...
        public static int[] PobierzHistogram256(int[] t)
        {
        ...
        public static int[] PobierzHistogram(int[] t)
        {
            int M;
            return PobierzHistogram(t, out M);
        }
        ...
        public static bool[] ProgójTablice(int[] t,int Próg,bool Odwrotność=false)
        {
            bool[] zw = new bool[t.Length];
            for (int i = 0; i < t.Length; i++)
            {
                zw[i] = t[i] > Próg^Odwrotność;
            }
            return zw;
        }

        internal static int ZnajdywanieRóźnicyŚrednichZProgiem(int S, int[] histogram, out int A, out int B)
        {
            int Przed = 0, Po = 0;
            long PrzedS = 0, PoS = 0;
            for (int i = 0; i < S; i++)
