...
namespace Loto
{
    public static unsafe class NaTabliceFloat
    {
        ...
        public static float[] TablicaWartościJednowymiarowa(Rectangle z,int Szerokośćwejścia,bool* Obraz, Size RozmiarWyjścia,float SkalerY=1)
        {
            float[,] tb = TablicaWartości(z, Szerokośćwejścia, Obraz, RozmiarWyjścia,SkalerY);
            if (tb==null)
            {
                return null;
            }
        ...
        public static float[,] TablicaWartości(Rectangle z,int SzerokośćWejścia, bool* Obraz, Size RozmarWyjścia,float ZwiekszenieY=1)
        {
            ...
            Size RozmiarWejscia = z.Size;
            RozmiarWejscia.Height = (int)(RozmiarWejscia.Height * ZwiekszenieY);
            float Skaler = PobierzSkaler(RozmiarWejscia, RozmarWyjścia,out PrzesuniecieX, out PrzesuniecieY);
            bool* Początek = Obraz + SzerokośćWejścia * z.Y + z.X;
            bool* przeglądany;
            float MnożnikY = (ZwiekszenieY * Skaler * (RozmiarWejscia.Height - 1)) / RozmiarWejscia.Height;
            float SKaleWielkościPiksela = Skaler *MnożnikY;
        ...
        private static float PobierzSkaler(Size z, Size rozmarWyjścia,out float PrzesóniecieX,out float PrzesóniecieY)
        {
            ...
            if (SX>SY)//wyszy obraz niż szerszy
            {
